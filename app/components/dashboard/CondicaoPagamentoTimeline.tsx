...
export function CondicaoPagamentoTimeline({ vendas, globalPeriodo, globalCustomInicio, globalCustomFim }: { vendas: Venda[]; globalPeriodo?: PeriodoGrafico; globalCustomInicio?: string; globalCustomFim?: string }) {
  return (
